fn main() {
    ...
    for _ in 0..t{
        ...
        let dist_points = rotating_calipers(convex_hull_points);

        println!("{} {} {} {}", dist_points.0.0, dist_points.0.1, dist_points.1.0, dist_points.1.1);
    }
}
...
fn rotating_calipers(ps: Vec<(i64, i64)>) -> ((i64, i64), (i64, i64)) {
    let n = ps.len();
    ...
    let mut points = (ps[left], ps[right]);
    ...
    for _ in 0..n {
        ...
        let max_dist = dist.max(dis(ps[left], ps[right]));
